    ...
    def fill_attendance():
        ...
        try:
            ...
            connection = pymysql.connect(
                host='localhost', user='root', password='Asmita@1807', db='manuallyfill_attendance')
...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            ...
            with open('StudentDetails/Student_details.csv', 'a+') as csvFile:
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    global cursor
                    connection = pymysql.connect(
                        host='localhost', user='root', password='Asmita@1807', db='Face_reco_fill')
                    cursor = connection.cursor()
                except Exception as e:
                    print(e)
